...
class JavaParserCodeSynthesizerDeepTest {
    ...
    void shouldMergeMultipleFragmentsIntelligently() {
        // given
        Intelligence intel = new Intelligence("com.test", "Calc", List.of(), List.of(), Intelligence.ComponentType.GENERAL, List.of());
        GeneratedCode setupFragment = new GeneratedCode(Set.of(), "@BeforeEach void setUp() { System.out.println(\"setup\"); }");
        ...
        // when
        String result = synthesizer.assembleStructuralTestClass("CalcTest", intel, setupFragment, testFragment1, testFragment2);
    ...
    @Test
    @DisplayName("GIVEN usage of BigDecimal without import WHEN assembling THEN it must be auto-injected")
    void shouldAutoInjectEssentialImports() {
        // given
        Intelligence intel = new Intelligence("com.test", "Calc", List.of(), List.of(), Intelligence.ComponentType.GENERAL, List.of());
        GeneratedCode fragment = new GeneratedCode(Set.of(), "public void test() { BigDecimal val = BigDecimal.ZERO; }");

        // when
        String result = synthesizer.assembleStructuralTestClass("CalcTest", intel, fragment);
