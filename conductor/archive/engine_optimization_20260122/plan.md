...
- [x] **Task: Enhance Context Extraction and Intelligence (TDD)**
    ...
    - [x] Verify tests pass in `common`.
- [x] **Task: Verification with demo-app**
    - [x] Re-generate tests for identified failure cases in `demo-app` and confirm quality improvement. (Partially restored manually due to Quota)
...
- [x] **Task: Verification with demo-app**
    ...
    - [x] `BankClient.java`: Next in queue. (Generated, found logic mismatch)
    - [x] Re-generate tests for remaining complex classes in `demo-app` (Focus: `PayrollService.java`) and confirm 100% compilability and quality.
